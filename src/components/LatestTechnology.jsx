...
import { next, prev, prevClick, nextDisable } from "../assets";
...
const TechCard = ({ icon, title, content, index }) => (
  <div
    className={`flex flex-row justify-start py-[30px] px-[40px] rounded-2xl bg-primary ml-3
      }`}
  >
  ...
  return (
    <section className={`${styles.paddingX} mt-[-50px]`}>
      ...
      <div className="flex justify-center mt-8 gap-10">
        <img src={prevClick} alt="" onClick={previous} />
